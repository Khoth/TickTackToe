...
{
	internal sealed class HorizontalLineBuildingStrategyTest : LineBuildingStrategyTestBase
	{
		public HorizontalLineBuildingStrategyTest()
			: base(new HorizontalLineBuildingStrategy())
		{
		}
